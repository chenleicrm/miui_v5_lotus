...
# instance fields
.field public mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;
...
.method private loadTask(Lorg/w3c/dom/Element;)V
    ...
    :cond_1
    new-instance v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    iget-object v5, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->this$0:Lmiui/maml/elements/AdvancedSlider;

    const/4 v6, 0x0

    invoke-direct {v4, v5, v6}, Lmiui/maml/elements/AdvancedSlider$UnlockAction;-><init>(Lmiui/maml/elements/AdvancedSlider;Lmiui/maml/elements/AdvancedSlider$1;)V

    iput-object v4, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    if-eqz v2, :cond_2

    iget-object v4, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    invoke-static {v2}, Lmiui/maml/util/Task;->load(Lorg/w3c/dom/Element;)Lmiui/maml/util/Task;

    move-result-object v5

    iput-object v5, v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->mTask:Lmiui/maml/util/Task;
    ...
    iput-object v5, v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->mCommand:Lmiui/maml/ActionCommand;

    iget-object v4, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    iget-object v4, v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->mCommand:Lmiui/maml/ActionCommand;
    ...
    iput-object v5, v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->mTrigger:Lmiui/maml/CommandTrigger;
    :try_end_0
    ...
    iget-object v4, v4, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->mTrigger:Lmiui/maml/CommandTrigger;
...
.method public finish()V
    ...
    iget-object v0, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiui/maml/elements/AdvancedSlider$EndPoint;->mAction:Lmiui/maml/elements/AdvancedSlider$UnlockAction;

    invoke-virtual {v0}, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->finish()V
...
.method public init()V
    ...
    invoke-virtual {v0}, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->init()V
...
.method public pause()V
    ...
    invoke-virtual {v0}, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->pause()V
...
.method public resume()V
    ...
    invoke-virtual {v0}, Lmiui/maml/elements/AdvancedSlider$UnlockAction;->resume()V
