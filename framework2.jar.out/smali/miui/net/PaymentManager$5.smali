...
.method constructor <init>(Lmiui/net/PaymentManager;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lmiui/net/PaymentManager$5;->val$serviceId:Ljava/lang/String;

    iput-object p3, p0, Lmiui/net/PaymentManager$5;->val$verify:Ljava/lang/String;
...
.method public onSuccess(Landroid/accounts/Account;)V
    ...
    iget-object v1, p0, Lmiui/net/PaymentManager$5;->val$serviceId:Ljava/lang/String;

    iget-object v2, p0, Lmiui/net/PaymentManager$5;->val$verify:Ljava/lang/String;

    #calls: Lmiui/net/PaymentManager;->internalGotoRechargeRecord(Landroid/accounts/Account;Ljava/lang/String;Ljava/lang/String;)V
    invoke-static {v0, p1, v1, v2}, Lmiui/net/PaymentManager;->access$400(Lmiui/net/PaymentManager;Landroid/accounts/Account;Ljava/lang/String;Ljava/lang/String;)V
